...
namespace Svelto.Tasks.Parallelism.ExtraLean
{
            ...
            where TTask : unmanaged, IBurstParallelTask
    {
        public MultiThreadedBurstParallelTaskCollection(string name, uint numberOfThreads, bool tightTasks)
        {
            ...
            _workers = new MultiThreadedParallelTaskCollection<WorkerDispatcher>(name.FastConcat(".Dispatchers"),
        ...
        sealed class WorkerState
        {
            internal void Add(in TTask prototype, int iterations, int elementsPerTask)
            {
                ...
                _definitions.Add(new RangeDefinition(prototype, iterations, elementsPerTask, _totalChunks, chunkCount));
        ...
        readonly MultiThreadedParallelTaskCollection<WorkerDispatcher> _workers;
